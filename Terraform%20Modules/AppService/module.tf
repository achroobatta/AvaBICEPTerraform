...
resource "azurerm_app_service_environment" "appse_environment" {
  count = var.appse_required ? 1 : 0
  name                         = var.appse_name
  resource_group_name          = var.resource_group_name
...
dynamic "cluster_setting" {
  for_each = var.cluster_setting != null ? ["true"] : []
  content {
...
resource "azurerm_linux_web_app" "linux" {
  count = var.linux_web_app_required ? 1 : 0
  name                       = var.linux_webb_app_name
  resource_group_name        = var.resource_group_name
  location                   = var.location
  tags                       = var.linux_tags
  ...
  dynamic "storage_account" {
     ...
     for_each = var.storage_account != null ? ["true"] : []
     content {
...
resource "azurerm_linux_web_app_slot" "slot" {
  count = var.linux_web_app_slot_required ? 1 : 0
  name           = var.linux_web_app_slot_name
  app_service_id = azurerm_linux_web_app.linux[count.index].id
...
resource "azurerm_windows_web_app" "windows" {
  count = var.windows_web_app_required ? 1 : 0
  name                       = var.windows_webb_app_name
  resource_group_name        = var.resource_group_name
  location                   = var.location
    ...
    content {
      ...
      dynamic "application_stack" {
        ...
        content {
          ...
          dotnet_version            = lookup(var.settings.site_config.application_stack, "dotnet_version", null)
          java_container            = lookup(var.settings.site_config.application_stack, "java_container", null)
          java_container_version    = lookup(var.settings.site_config.application_stack, "java_container_version", null)
          php_version               = lookup(var.settings.site_config.application_stack, "php_version", null)
          java_version              = lookup(var.settings.site_config.application_stack, "java_version", null)
          node_version              = lookup(var.settings.site_config.application_stack, "node_version", null)
          python_version            = lookup(var.settings.site_config.application_stack, "python_version", null)
...
resource "azurerm_windows_web_app_slot" "slot" {
  count = var.windows_web_app_slot_required ? 1 : 0
  name           = var.windows_web_app_slot_name
  app_service_id = azurerm_windows_web_app.windows[count.index].id
