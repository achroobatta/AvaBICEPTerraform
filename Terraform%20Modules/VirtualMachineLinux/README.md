...
Reference for Linux VM resource provider: https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/linux_virtual_machine
...
| admin_username | admin_username | "linadmin" | string<br/>senstive |
| admin_password | define the admin user password to be created. Random complex password will be generated if left empty together with admin_ssh_key | null | string<br/>senstive |
| admin_ssh_key | admin ssh key, cannot be used together with admin_password | null | any<br/>senstive |
...
| certificates | refer to VM resource provider for usage for certificate block | null | list(object({<br/>url = string<br/>})) |
...
# Additional details
## Simple code sample with in module data disk creation with ssh key
```
